...
public class ActionValidator {
     ...
     */
    public static List<InvalidAction> validate(GameState gameState, String playerId, Action[] actions) {
     ...
     */
    private static InvalidAction validateSingleAction(GameState gameState, String playerId, Action action) {
